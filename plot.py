...
# ]
params = [
    Params(0.3875, 0.1375, 0.1125, 0.6625, SupportedDistributions.normal),
    Params(0.5,    0.1375, 0.225,  0.775,  SupportedDistributions.normal),
    Params(0.6125, 0.1375, 0.3375, 0.8875, SupportedDistributions.normal)
]
